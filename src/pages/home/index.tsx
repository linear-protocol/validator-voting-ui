        ...
        <div className="flex flex-col w-full">
          <Markdown
            content={
              ...
              "- If the voting power of your validator is `0` on the details page, it's probably because your node is kicked out. Please try vote again if you met such case.\n" +
              '\n' +
