        ...
        <div className="flex flex-col w-full">
          <Markdown
            content={
              ...
              '\n' +
              '```bash\n' +
              `NEAR_ENV=${NEAR_ENV} near call ${config.proposalContractId} vote '{"staking_pool_id":"<validator-account-id>","is_vote":true}' --accountId <validator-owner-id> --gas 200000000000000\n` +
              '```\n'
            }
          />
        </div>
